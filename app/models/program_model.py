...
class Program(Base):
    ...
    form_configuration_id = Column(UUID(as_uuid=True), ForeignKey("program_form_configurations.id"), nullable=True, index=True)
    form_configuration_version_id = Column(UUID(as_uuid=True), ForeignKey("program_form_configuration_versions.id"), nullable=True, index=True)

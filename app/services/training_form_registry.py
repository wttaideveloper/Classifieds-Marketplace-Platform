...
FIELD_REGISTRY: list[dict] = [
    ...
    _entry("tags", "Tags", "array", ["text", "multi_select"]),
    _entry("start_time", "Start Time", "string", ["text", "time"], default_renderer="time"),
    _entry("end_time", "End Time", "string", ["text", "time"], default_renderer="time"),
    _entry("venue", "Venue", "string", ["text"]),
    _entry("address", "Address", "string", ["textarea", "text"], default_renderer="textarea"),
    _entry("instructor_name", "Instructor Name", "string", ["text"]),
    _entry("instructor_bio", "Instructor Bio", "string", ["textarea", "text"], default_renderer="textarea"),
    _entry("level", "Level", "string", ["select", "text"], default_renderer="select"),
    _entry("language", "Language", "string", ["text", "select"]),
    _entry("gallery_images", "Gallery Images", "array", ["url", "text"]),
    _entry("documents", "Documents", "array", ["url", "text"]),
    _entry("instructor_photo", "Instructor Photo", "string", ["url", "text"], default_renderer="url"),
    _entry("instructor_credentials", "Instructor Credentials", "string", ["textarea", "text"], default_renderer="textarea"),
    _entry("prerequisites", "Prerequisites", "array", ["text", "multi_select"]),
    _entry("release_rule", "Release Rule", "object", ["json"], default_renderer="json"),
    _entry("scheduled_publication", "Scheduled Publication", "datetime", ["datetime", "date"], default_renderer="datetime"),
    _entry("randomise", "Randomise Question Order", "boolean", ["checkbox"], default_renderer="checkbox"),
    _entry("is_mandatory", "Mandatory Course", "boolean", ["checkbox"], default_renderer="checkbox"),
    _entry("subtitle", "Subtitle", "string", ["text"]),
    _entry("faqs", "FAQs", "array", ["json", "text"], default_renderer="json"),
    _entry("badges", "Badges", "array", ["json", "text"], default_renderer="json"),
]
